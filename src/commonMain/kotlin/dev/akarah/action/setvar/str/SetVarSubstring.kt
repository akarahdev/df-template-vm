...
object SetVarSubstring : ImperativeAction {
    ...
    override fun execute(
        ...
        lineVars[varIdx] = baseStr.substring(
            (registers[2] as DecimalLong).toInt() - 1,
            (registers[3] as? DecimalLong)?.toInt() ?: baseStr.length
        )
    }
}